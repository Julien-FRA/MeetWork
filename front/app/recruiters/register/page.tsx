import RegisterForm from "@/app/recruiters/register/components/RegisterForm";
import { Button } from "@/components/ui/button";
import Link from "next/link";

export default function RecruitersRegisterPage() {
  return (
    <main className="flex min-h-screen w-full max-w-4xl flex-col items-center justify-center mx-auto py-32 px-16 bg-white dark:bg-black gap-3">
      ...
      <div className="flex flex-row items-center">
        ...
        <Button variant="link" className="ml-2 p-0">
          <Link href="/recruiters/login">Se connecter</Link>
        </Button>
      </div>
    </main>
  );
